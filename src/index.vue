<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="新建时间" prop="time">
        <el-input
    ...
    <el-table v-loading="loading" :data="articleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="新建时间" align="center" prop="time" />
      <el-table-column label="文章标题" align="center" prop="title" />
      <el-table-column label="文章内容" align="center" prop="innerHtml" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="新建时间" prop="time">
          <el-input v-model="form.time" placeholder="请输入新建时间" />
        </el-form-item>
        <el-form-item label="文章标题" prop="title">
          <el-input v-model="form.title" placeholder="请输入文章标题" />
        </el-form-item>
        <el-form-item label="文章内容" prop="innerHtml">
          <el-input v-model="form.innerHtml" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="文章类型" prop="type">
          <el-input v-model="form.type" placeholder="请输入文章类型" />
        </el-form-item>
        <el-form-item label="关键字" prop="keyword">
