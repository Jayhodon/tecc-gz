...
<template>
  <div class="main">
    <div class="row">
      <a target="_blank" class="item" v-for="(item, index) in info" :key="index" :href="item.url">
...
// import { getTrademarkList } from "../api/httpRequest";
export default {
  name: "MyPractice",
  props: {},
  components: {},
  ...
  setup() {
    ...
    const handleTrademarkList = () => {
      // getTrademarkList().then((res) => {
